...
<body class="sub-bg digital-marketing">
    ...
    <main class="main-bg">
        ...
        <header class="header-main-crev sub-bg">
            <div class="container ontop">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="caption">
                            <h1 class="fz-80">Digital marketing <br> the new way.</h1>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex align-items-center">
                        <div>
                            <div class="text">
                                <p>We take a similar approach to design commercial we do impactfully approches over the
                                    flowchart of user friendly wireframe.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="main-marq dark-text">
                            <div class="slide-har st1">
                                <div class="box non-strok">
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>UI-UX Experience</span> <span
                                    ...
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Digital Marketing</span> <span
                                                class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Mobile Solutions</span> <span
                                                class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                </div>
                                <div class="box non-strok">
        ...
        <section class="intro-serv section-padding">
            <div class="container">
                <div class="row md-marg justify-content-center">
                    <div class="col-lg-5">
                        <div class="cont md-mb50">
                            <div class="mb-50">
                                <h6 class="sub-title mb-15">What we do ?</h6>
                                <h3>We want to bring business & the digital world together.</h3>
                            </div>
                            <div class="item d-flex align-items-center pb-20 mb-20 bord-thin-bottom">
                                <div>
                                    <div class="icon-img-50 mr-60">
                                ...
                                <div>
                                    ...
                                    <a href="page-services.html" class="arrow mt-20">
                                        <span class="fz-13 mr-10">Read More</span>
                                        <span class="circle">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="item d-flex align-items-center pb-20 bord-thin-bottom">
                                <div>
                                    <div class="icon-img-50 mr-60">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="my-paroller" data-paroller-factor="0.3" data-paroller-type="foreground"
                            ...
                            <img src="assets/imgs/about/v1.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="text-center mb-50">
                            <h6 class="fz-14 fw-400">More than <span class="fw-600">200+ companies</span> trusted us
                                worldwide</h6>
                        </div>
                    </div>
                </div>
                <div class="swiper5" data-carousel="swiper" data-items="5" data-loop="true" data-space="40" data-speed="1000">
        ...
        <section class="sideimg-numbers section-padding sub-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="cont">
                            <div>
                                <h6 class="sub-title mb-15">Who we are ?</h6>
                                <h2 class="fz-50">We want to bring business & the digital world together.</h2>
                                <div class="underline">
                                    <a href="page-about.html" class="arrow mt-30">
                                        <span class="sub-title">Explore about us</span>
                                        <span class="circle">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
            ...
            <div class="bg-img bg-left parallaxie d-flex align-items-center justify-content-center" data-background="assets/imgs/background/3.jpg">
                <div class="vid-circle bg-white text-dark">
                    ...
                    <div class="col-12">
                        <div class="main-marq xlrg">
                            <div class="slide-har st1 strok">
                                <div class="box">
                                    <div class="item">
                                        <h4 class="stroke opacity-4">Amazing Services</h4>
                                    </div>
                                    <div class="item">
                                        <h4 class="stroke opacity-4">Amazing Services</h4>
                                    </div>
                ...
                <div class="row md-marg content">
                        ...
                        <div>
                            <ul class="rest">
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="mb-30 pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/1.jpg">
                                ...
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="mb-30 pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/2.jpg">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-80">
                                                <span class="icon-img-50">
                                                    <img src="assets/imgs/serv-icons/1.png" alt="">
                                ...
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="md-mb30 pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/3.jpg">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-80">
                                                <span class="icon-img-50">
                                                    <img src="assets/imgs/serv-icons/2.png" alt="">
                    ...
                    <div class="col-lg-6">
                        <div>
                            <ul class="rest">
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="mb-30 pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/4.jpg">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-80">
                                                <span class="icon-img-50">
                                                    <img src="assets/imgs/serv-icons/0.png" alt="">
                                ...
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="mb-30 pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/5.jpg">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-80">
                                                <span class="icon-img-50">
                                                    <img src="assets/imgs/serv-icons/1.png" alt="">
                                ...
                                <li class="block" data-fx="1">
                                    <a href="project-details1.html" class="pb-30 bord-thin-bottom full-width block__title" data-img="assets/imgs/serv-img/6.jpg">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-80">
                                                <span class="icon-img-50">
                                                    <img src="assets/imgs/serv-icons/2.png" alt="">
        ...
        <section class="work-carsouel section-padding sub-bg">
            <div class="container">
                <div class="sec-head mb-80">
                    <div class="row">
                        <div class="col-lg-6">
                            <h6 class="sub-title mb-15">Our Portfolio</h6>
                            <h2 class="fz-50">Selected Projects.</h2>
                        </div>
                        <div class="col-lg-6 d-flex align-items-center">
            ...
            <div class="container-fluid rest">
                <div class="row">
                    <div class="col-12">
                        <div class="work-crus work-crus3 random out" data-carousel="swiper" data-items="3" data-center="center"
                            data-loop="true" data-space="120" data-speed="1000">
                ...
                <div class="row justify-content-around">
                    <div class="col-lg-5 valign md-mb50">
                        <div class="imgs full-width mb-80">
                            <div class="img1 main-color2 wow fadeInUp">
        ...
        <section class="testim-crv2 sub-bg">
            <div class="container section-padding position-re">
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="swiper-controls testim-controls arrow-out d-flex mt-80">
                ...
                <div class="half-img-right bg-img ontop md-hide" data-background="assets/imgs/testim/01.png"></div>
            </div>
        </section>
        ...
        <section class="blog-modern section-padding">
            <div class="container">
                <div class="sec-head mb-80">
                    <div class="row">
                        <div class="col-lg-6">
                            <h6 class="sub-title mb-15">Latest News</h6>
                            <h2 class="fz-50">Our News.</h2>
                        </div>
                        <div class="col-lg-6 d-flex align-items-center">
                            <div class="full-width">
                                <div class="d-flex justify-content-end justify-end">
                        ...
                        <div class="swiper-wrapper curs-scroll">
                            <div class="swiper-slide wow fadeInUp" data-wow-delay=".1s">
                                <div class="item">
                                    ...
                                    <div class="cont mt-30">
                                        ...
                                        <a href="blog-post.html" class="mt-20 ls1 sub-title">Read More <i
                            ...
                            <div class="swiper-slide wow fadeInUp" data-wow-delay=".5s">
                                <div class="item">
                                    ...
                                    <div class="cont mt-30">
                                        <h6>
                                            <a href="blog-post.html">We create some things for your success in future
                                                growth</a>
                                        </h6>
                                        <a href="blog-post.html" class="mt-20 ls1 sub-title">Read More <i
                                                class="ml-5"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
        ...
        <section class="call-action-center section-padding position-re sub-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="sec-lg-head text-center">
                            <h2 class="fz-70 fw-700">
                                ...
                                <span class="underline"><a href="page-contact.html" class="main-color2">Let’s get to work.</a></span>
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <section class="call-marq">
            <div class="container-fluid main-colorbg2 rest no-skew pt-20 pb-15">
                <div class="row">
                    <div class="col-12">
                        <div class="main-marq dark-text">
                            <div class="slide-har st1">
