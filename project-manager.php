...
<body class="home-freelancer main-bg">
    ...
    <header class="header-freelancer full-height bord-thin-bottom valign position-re" data-overlay-dark="5" data-scroll-index="0">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="caption">
                        ...
                        <div class="row mt-50">
                            <div class="col-lg-3 cal-act order2">
                                <a href="portfolio-classic-grid.html" class="butn-circle d-flex align-items-center text-center">
                            ...
                            <div class="col-lg-8 offset-lg-1 valign order1 md-mb50">
                                <p class="fz-16">We appreciate your trust greatly our clients choose us & our products
        ...
        <div class="bg-img" data-background="assets/imgs/freelancer/h2.png"></div>
    </header>
    ...
    <main class="position-re">
                        ...
                        <div class="main-marq light-text">
                            <div class="slide-har st1">
                                <div class="box non-strok">
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>UI-UX Experience</span> <span class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Web Development</span> <span class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Digital Marketing</span> <span class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Product Design</span> <span class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                    <div class="item">
                                        <h4 class="d-flex align-items-center"><span>Mobile Solutions</span> <span class="fz-50 ml-50 stroke icon">*</span></h4>
                                    </div>
                                </div>
                                <div class="box non-strok">
                                    <div class="item">
        ...
        <section class="serv-box section-padding" data-scroll-index="1">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="position-re">
                                ...
                                <h2 class="fz-50">Our Services</h2>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="serv-item d-flex mb-30 radius-10">
                            <div class="icon-img-80">
                                <img src="assets/imgs/serv-icons/0.png" alt="">
                            </div>
                            <div class="ml-60">
                                <h5 class="mb-15">Brand Strategy & <br> Art Direction</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="serv-item d-flex mb-30 radius-10">
                            ...
                            <div class="ml-60">
                                <h5 class="mb-15">UX/UI Design & <br> Website/App Design</h5>
                                <p>Creating a higher spacing and how people move through a unique.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="serv-item d-flex radius-10 md-mb30">
                            <div class="icon-img-80">
                                <img src="assets/imgs/serv-icons/0.png" alt="">
                            </div>
                            <div class="ml-60">
                    ...
                    <div class="col-lg-6">
                        <div class="serv-item d-flex radius-10">
                            <div class="icon-img-80">
                                <img src="assets/imgs/serv-icons/1.png" alt="">
                            </div>
                            <div class="ml-60">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 valign md-hide">
                        <h2 class="max-text" data-text=" Creative UI - UX Designer."> Creative UI - UX Designer.</h2>
                    </div>
                    <div class="col-lg-3 order2">
                        <div class="img">
                            <img src="assets/imgs/freelancer/h2.png" alt="" class="parallax" data-speed="0.01">
                            <span class="star-shape">
                                <img src="assets/imgs/svg-assets/star-shape.png" alt="" class="parallax" data-speed="-0.01">
                            </span>
                        </div>
                    </div>
                    <div class="col-lg-3 valign order1">
                        <div class="text-qoute">
                            <span class="exp mb-30 main-bg">7+ Years Experience</span>
            ...
            <div class="container">
                <div class="sec-lg-head mb-50">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="position-re">
                                <h6 class="dot-titl-non mb-10">Portfolio</h6>
                                <h2 class="fz-50">Selected Works</h2>
                            </div>
                        </div>
                        <div class="col-lg-5 d-flex align-items-center">
                            <div class="full-width d-flex justify-content-end justify-end">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="item mt-30">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1"><a href="project-details1.html">GeekFolio Architecture</a></h6>
                                </div>
                                <div class="ml-auto">
                    ...
                    <div class="col-lg-6">
                        <div class="item mt-30">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1"><a href="project-details1.html">Luxury Modern Chair</a></h6>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© 2023</p>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="item mt-30">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1"><a href="project-details1.html">Partiner BPO</a></h6>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© 2023</p>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="item mt-30">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1"><a href="project-details1.html">From our gallery</a></h6>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© 2023</p>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="item mt-30">
                            ...
                            <div class="cont mt-30 d-flex">
                                <div>
                                    <h6 class="line-height-1"><a href="project-details1.html">Astra Brand Identity</a></h6>
                                </div>
                                <div class="ml-auto">
                                    <p class="fz-14">© 2023</p>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sec-lg-head mb-80">
                            <div class="position-re">
                                <h6 class="dot-titl-non mb-10">Skills & Experience</h6>
                                <h2 class="fz-50">My Experience</h2>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 valign">
                        <div class="sec-lg-head md-mb80">
                            <div class="position-re">
                                <h6 class="dot-titl-non mb-10">What Clients Says?</h6>
                                <h2 class="fz-50">Testimonials</h2>
                            </div>
        ...
        <section class="blog-list-half crev section-padding sub-bg" data-scroll-index="6">
            <div class="container">
                <div class="sec-lg-head mb-80">
                    <div class="row">
                        <div class="col-lg-7">
                            <h6 class="dot-titl-non mb-10">Our Blog</h6>
                            <h2 class="fz-50">Latest News</h2>
                        </div>
                        <div class="col-lg-5 d-flex align-items-center">
                            <div class="full-width d-flex justify-content-end justify-end">
                                <div class="vew-all">
                                    <a href="blog-half-img.html">View All Our News
                                        <span>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <div class="col-lg-6">
                        <div class="item md-mb80">
                            <div class="row rest">
                                <div class="col-md-6">
                                    <div class="img">
                                        <img src="assets/imgs/sass-img/blog/1.jpg" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="item">
                            <div class="row rest">
                                <div class="col-md-6">
                                    <div class="img">
                                        <img src="assets/imgs/sass-img/blog/2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6 valign">
                                    <div class="cont">
