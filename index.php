                ...
                <header class="crev-header">
                    <div class="container mt-80">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="caption">
                                    <h1>Script<span class="stroke">Motor</span> <br> Infrastructure</h1>
                                    <div class="row mt-30">
                                ...
                                <div class="main-marq">
                                    <div class="slide-har st1">
                                        <div class="box non-strok">
                                            ...
                                            <div class="item">
                                                <h4 class="d-flex align-items-center"><span>DevOps</span>
                                                    <span class="fz-50 ml-50 stroke icon">*</span>
                                                </h4>
                                            </div>
                                            <div class="item">
                                            ...
                                            <div class="item">
                                                <h4 class="d-flex align-items-center"><span>Backend Development</span>
                                                    <span class="fz-50 ml-50 stroke icon">*</span>
                                                </h4>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="serv-item lg-pad md-mb50 radius-5 wow fadeIn" data-wow-delay=".5s">
                                    ...
                                    <h6 class="mb-15">Frontend Development</h6>
                                    <p class="fz-14">Creating a higher spacing and how people move through a unique.</p>
                                    <div class="crv-more">
                                        <a href="frontend.php" class="mt-30 ls1 fz-12 text-u">Read More<svg
